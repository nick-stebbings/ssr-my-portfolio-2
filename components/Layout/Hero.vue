  ...
  <div class="hero-container">
    ...
    <div class='icons'>
      <div class='icon-container'>
        <a href='https://www.linkedin.com/in/nick-stebbings-567ba4224/' target='_blank' class='icon-link'>
          <span class='icon-label'>LinkedIn</span>
          <svg class='icon-svg' xmlns='http://www.w3.org/2000/svg' viewBox='-24 -24 72 72' fill='currentColor'
      ...
      <div class='icon-container'>
        <a href='https://github.com/nick-stebbings' target='_blank' class='icon-link'>
      ...
      <div class='icon-container'>
        <a href='https://n-stebbings.medium.com/' target='_blank' class='icon-link'>
      ...
      <div class='icon-container'>
        <a href='https://www.codewars.com/users/nick-stebbings' target='_blank' class='icon-link'>
          <span class='icon-label'>CodeWars</span>
          <svg class='icon-svg' xmlns='http://www.w3.org/2000/svg' viewBox='-24 -24 72 72' fill='currentColor'
