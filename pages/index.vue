<template>
  <Layout>
    ...
    <template #hero>
      <Hero
        heading="I make amazing interactive web experiences"
        button-text="Book Me"
...
const activeProjects = computed(
  () =>
    ['web3', 'ecommerce', 'elearning'].includes(activeLayer.value) &&
    projects[activeLayer.value]
)
...
let currentHeaderChangeSetTimeout
function hoverLayerActive(layerName) {
...
function slide(direction, articleName, event = null) {
  if (
    event &&
